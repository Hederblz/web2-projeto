    ...
    <div class="row justify-content-center">
        <div class="col-md-10 col-lg-8">
            ...
            <div class="d-flex justify-content-between align-items-center mb-4">
                <h2 class="fw-bold text-dark mb-0">Novo Produto</h2>
                ...
                <div class="card-body p-4 p-md-5">
                    <form action="{{ route('produtos.store') }}" method="POST">
                        ...
                        <div class="mb-4">
                            ...
                            <input type="text" name="nome" id="nome" class="form-control form-control-lg bg-light border-0" placeholder="Ex: Teclado Mecânico" required autofocus>
                        </div>
                        ...
                        <div class="row">
                            <div class="col-md-6 mb-4">
                                ...
                                <div class="input-group input-group-lg shadow-none">
                                    ...
                                    <input type="number" step="0.01" name="preco" id="preco" class="form-control bg-light border-0" placeholder="0.00" required>
                                </div>
                            </div>
                            
                            <div class="col-md-6 mb-4">
                                <label for="estoque" class="form-label fw-semibold text-secondary">Estoque Inicial</label>
                                <input type="number" name="estoque" id="estoque" class="form-control form-control-lg bg-light border-0" placeholder="Quantidade em estoque" required>
                            </div>
                        </div>

                        <div class="mb-4">
                            <label for="descricao" class="form-label fw-semibold text-secondary">Descrição</label>
                            <textarea name="descricao" id="descricao" class="form-control bg-light border-0" rows="4" placeholder="Detalhes do produto..."></textarea>
                        </div>
